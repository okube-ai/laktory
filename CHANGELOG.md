...
* Added support for multiple nodes writing to the same table with Lakeflow / Spark Declarative Pipeline orchestrators, through append flows. [[#676](https://github.com/okube-ai/laktory/issues/676)]
### Fixed
