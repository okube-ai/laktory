    ...
    return models.Pipeline(
        ...
        nodes=[
            ...
            models.PipelineNode(
                name="slv_b2",
                execution_task_name="slv_b",
                sources={"df": {"node_name": "brz_b"}},
                tags=["slv", "b"],
                sinks=[_SINK],
            ),
            models.PipelineNode(
                name="gld_b",
                sources={"df": {"node_name": "slv_b1"}},
                tags=["gld", "b"],
                sinks=[_SINK],
            ),
        ],
...
def pl_with_views():
    return models.Pipeline(
        ...
        nodes=[
            ...
            models.PipelineNode(name="slv", sources={"df": {"node_name": "brz"}}),
            models.PipelineNode(
                name="gld1", sources={"df": {"node_name": "slv"}}, sinks=[_SINK]
            ),
            models.PipelineNode(name="gld2", sources={"df": {"node_name": "slv"}}),
        ],
    )
