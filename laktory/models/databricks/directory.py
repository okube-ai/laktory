...
class Directory(BaseModel, PulumiResource):
    ...
    print(d)
    '''
    resource_name_=None options=ResourceOptions(variables={}, depends_on=[], provider=None, aliases=None, delete_before_replace=True, ignore_changes=None, import_=None, parent=None, replace_on_changes=None) _core_resources=None variables={} path='/queries/views' delete_recursive=None
    '''
