...
def _update_quality_monitors():
    """Update pipeline tables quality monitors as a script"""
    ...
    parser = argparse.ArgumentParser(
        description="Read pipeline configuration file and update quality monitors"
    )
    parser.add_argument(
    ...
    logger.info(f"Executing quality monitor updates for pipelines {filepaths}")
