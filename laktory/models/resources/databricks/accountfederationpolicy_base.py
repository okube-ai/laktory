...
# Regenerate with: python scripts/build_resources/01_build.py databricks_account_federation_policy
...
class AccountFederationPolicyOidcPolicy(BaseModel):
...
class AccountFederationPolicyBase(BaseModel, TerraformResource):
    """
    Generated base class for `databricks_account_federation_policy`.
    ...
    policy_id: str | None = Field(
        None, description="The ID of the federation policy. Output only"
    )
    ...
    oidc_policy: AccountFederationPolicyOidcPolicy | None = Field(None)
...
__all__ = ["AccountFederationPolicyBase", "AccountFederationPolicyOidcPolicy"]
