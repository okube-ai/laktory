...
class EntitlementsBase(BaseModel, TerraformResource):
    ...
    allow_instance_pool_create: bool | None = Field(
        None,
        description="Allow the principal to have instance pool create privileges. Defaults to false. More fine grained permissions could be assigned with databricks_permissions and instance_pool_id argument",
    )
