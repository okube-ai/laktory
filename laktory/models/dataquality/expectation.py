...
class DataQualityExpectation(BaseModel, PipelineChild):
    ...
    print(dqe)
    '''
    dataframe_backend_=None dataframe_api_=None full_refresh_mode_=None variables={} action='WARN' type='ROW' name='price higher than 10' expr=DataFrameColumnExpr(dataframe_backend_=None, dataframe_api_='NARWHALS', full_refresh_mode_=None, variables={}, expr='close > 127', type='SQL', dataframe_backend=<DataFrameBackends.PYSPARK: 'PYSPARK'>, dataframe_api='NARWHALS', full_refresh_mode='DROP') tolerance=ExpectationTolerance(variables={}, abs=None, rel=0.05) dataframe_backend=<DataFrameBackends.PYSPARK: 'PYSPARK'> dataframe_api='NARWHALS' full_refresh_mode='DROP'
    '''
    ...
    print(dqe)
    '''
    dataframe_backend_=None dataframe_api_=None full_refresh_mode_=None variables={} action='WARN' type='AGGREGATE' name='rows count' expr=DataFrameColumnExpr(dataframe_backend_=None, dataframe_api_='NARWHALS', full_refresh_mode_=None, variables={}, expr='COUNT(*) > 50', type='SQL', dataframe_backend=<DataFrameBackends.PYSPARK: 'PYSPARK'>, dataframe_api='NARWHALS', full_refresh_mode='DROP') tolerance=ExpectationTolerance(variables={}, abs=0, rel=None) dataframe_backend=<DataFrameBackends.PYSPARK: 'PYSPARK'> dataframe_api='NARWHALS' full_refresh_mode='DROP'
    '''
    ```
